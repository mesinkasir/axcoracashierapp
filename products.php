					...
					<div class="card-body">
							...
							<div class="form-group">
								<div class="custom-control custom-switch">
								  ...
								  <label class="custom-control-label" for="status">Activated</label>
								</div>
							</div>
					</div>
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								...
								<button class="btn btn-sm btn-secondary btn-block" type="button" onclick="$('#manage-product').get(0).reset()"> Reset</button>
							</div>
						</div>
					</div>
				</div>
